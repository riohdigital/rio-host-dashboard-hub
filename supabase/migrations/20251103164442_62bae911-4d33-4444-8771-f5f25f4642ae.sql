-- Reverter fn_get_all_cleaner_reservations para usar check_out_date (data da faxina necessária)
-- Esta função é usada na Gestão de Faxinas onde faxinas devem ser feitas no checkout
